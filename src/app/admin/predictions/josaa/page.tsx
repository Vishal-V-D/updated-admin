...
const accuracyChartData = [
  { name: "Accuracy", value: 97, fill: "hsl(180 60% 50%)" }, // Cyan color
];

const accuracyChartConfig = {
  value: {
    label: "Accuracy",
    color: "hsl(180 60% 50%)", // Cyan color
  },
    ...
    <PageContainer>
      <div className="flex-1 flex-col space-y-6 min-h-screen p-4 sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <CardFooter className="flex-col gap-2 text-sm pt-0">
              <div className="flex w-full justify-between items-center leading-none">
                <div className="flex items-center gap-2 font-medium">
                  ...
                  Trend: <span className="text-green-500">Up 2%</span>
                </div>
          ...
          {/* New Card: Average Rank Analytics */}
          <Card className="flex flex-col sm:col-span-1">
            <CardHeader className="items-center pb-0">
              <CardTitle>Average Rank Analytics</CardTitle>
              <CardDescription>Predicted JEE ranks based on user data</CardDescription>
            </CardHeader>
            <CardContent className="flex-1 flex flex-col justify-center gap-4 py-4">
              <div className="flex items-center justify-between text-center">
                <div className="flex flex-col items-center flex-1">
                  <div className="text-3xl font-bold text-gray-900 dark:text-gray-50">~2,500</div>
                  <p className="text-xs text-muted-foreground">Average Rank</p>
                </div>
                <Separator orientation="vertical" className="h-10 mx-2" />
                <div className="flex flex-col items-center flex-1">
                  <div className="text-3xl font-bold text-gray-900 dark:text-gray-50">4,100</div>
                  <p className="text-xs text-muted-foreground">Median Rank</p>
                </div>
              </div>
            </CardContent>
            <CardFooter className="flex-col items-start gap-2 text-sm pt-0">
              <div className="text-muted-foreground leading-none">
                <span className="font-semibold">Top 1% Rank Range:</span> 1 - 950
              </div>
              <div className="text-muted-foreground leading-none">
                <span className="font-semibold">Total Data Points:</span> 18.5K Predictions
              </div>
            </CardFooter>
          </Card>
        </div>
